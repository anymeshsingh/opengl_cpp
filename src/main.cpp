...
bool platform_create_window(int width, int height, char* title)
{
    ...
    wc.hCursor = LoadCursor(NULL, IDC_ARROW);         // Use arrow mouse cursor 
    wc.lpszClassName = title;                         // Not the title, just a unique identifier
...
int main()
{
    ...
    platform_create_window(1200, 720, "Main");
